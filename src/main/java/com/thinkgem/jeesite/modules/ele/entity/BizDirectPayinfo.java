...
public class BizDirectPayinfo extends DataEntity<BizDirectPayinfo> {
	...
	@ExcelField(title="账期", align=2, sort=244)
	...
	@ExcelField(title="户号", align=2, sort=245)
	...
	@ExcelField(title="起始日期", align=2, sort=246)
	...
	@ExcelField(title="截止日期", align=2, sort=247)
	...
	@ExcelField(title="起始读数", align=2, sort=248)
	...
	@ExcelField(title="截止读数", align=2, sort=249)
	...
	@ExcelField(title="老表起始读数", align=2, sort=250)
	...
	@ExcelField(title="老表截止读数", align=2, sort=251)
	...
	@ExcelField(title="倍率", align=2, sort=252)
	...
	@ExcelField(title="损耗", align=2, sort=253)
	...
	@ExcelField(title="计费电量", align=2, sort=254)
	...
	@ExcelField(title="票面金额", align=2, sort=255)
	...
	@ExcelField(title="票据类型", align=2, sort=256)
	...
	@ExcelField(title="铁塔起始日期", align=2, sort=257)
	...
	@ExcelField(title="铁塔截止日期", align=2, sort=258)
