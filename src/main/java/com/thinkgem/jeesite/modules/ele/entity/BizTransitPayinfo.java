...
public class BizTransitPayinfo extends DataEntity<BizTransitPayinfo> {
	...
	@Length(min=1, max=25, message="户号长度必须介于 1 和 25 之间")
	@ExcelField(title="户号", align=2, sort=136)
	...
	@ExcelField(title="缴费日期", align=2, sort=137)
	...
	@ExcelField(title="起始日期", align=2, sort=138)
	...
	@ExcelField(title="截止日期", align=2, sort=139)
	...
	@ExcelField(title="起始读数", align=2, sort=140)
	...
	@ExcelField(title="截止读数", align=2, sort=141)
	...
	@ExcelField(title="老表起始读数", align=2, sort=142)
	...
	@ExcelField(title="老表截止读数", align=2, sort=143)
	...
	@ExcelField(title="倍率", align=2, sort=144)
	...
	@ExcelField(title="损耗", align=2, sort=145)
	...
	@ExcelField(title="计费电量", align=2, sort=146)
	...
	@ExcelField(title="电费单价", align=2, sort=147)
	...
	@ExcelField(title="票面金额", align=2, sort=148)
	...
	@ExcelField(title="代开税金", align=2, sort=149)
	...
	@ExcelField(title="票据类型（代开）", align=2, sort=150)
	...
	@ExcelField(title="总金额", align=2, sort=151)
	...
	@ExcelField(title="供电方名称", align=2, sort=152)
	...
	@JsonFormat(pattern = "yyyy-MM-dd")
	@ExcelField(title="核销日期", align=2, sort=153)
	...
	@ExcelField(title="报账单号", align=2, sort=154)
	...
	@ExcelField(title="支付单号", align=2, sort=155)
	...
	@ExcelField(title="核销单号", align=2, sort=156)
