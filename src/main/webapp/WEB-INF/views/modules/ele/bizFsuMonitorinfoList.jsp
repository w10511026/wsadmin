...
<body>
	...
	<form:form id="searchForm" modelAttribute="bizFsuMonitorinfo" action="${ctx}/ele/bizFsuMonitorinfo/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
				...
				<input onclick="deletebatch('${ctx}/ele/bizFsuMonitorinfo/deletebatch')" class="btn btn-primary" type="button" value="删除"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
		...
		<c:forEach items="${page.list}" var="bizFsuMonitorinfo">
			<tr>
				<td hidden><span id="${bizFsuMonitorinfo.id}ids">${bizFsuMonitorinfo.id}</span></td>
