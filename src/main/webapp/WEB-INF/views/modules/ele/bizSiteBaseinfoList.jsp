	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizSiteBaseinfo">
			<tr>
				...
				<td>
					<fmt:formatDate value="${bizSiteBaseinfo.sicmq}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${bizSiteBaseinfo.sictq}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${bizSiteBaseinfo.sicuq}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
