...
<body>
	...
	<form:form id="searchForm" modelAttribute="bizSiteMeterinfo" action="${ctx}/ele/bizSiteMeterinfo/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
				...
				<input onclick="deletebatch('${ctx}/ele/bizSiteMeterinfo/deletebatch')" class="btn btn-primary" type="button" value="删除"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
		...
		<c:forEach items="${page.list}" var="bizSiteMeterinfo">
			<tr>
				<td hidden><span id="${bizSiteMeterinfo.id}ids">${bizSiteMeterinfo.id}</span></td>
