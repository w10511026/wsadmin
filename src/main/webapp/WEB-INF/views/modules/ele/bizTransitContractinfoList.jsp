	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="bizTransitContractinfo">
			<tr>
				...
				<td>
					<fmt:formatDate value="${bizTransitContractinfo.tconstartdate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					<fmt:formatDate value="${bizTransitContractinfo.tconenddate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
				...
				<td>
					<fmt:formatDate value="${bizTransitContractinfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
